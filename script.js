...
function createEvents() {
  ...
  var event12 = [11,'Rasmus Seebach koncert','Oplev poplegenden Rasmus Seebach, når han gæster Vrøgum på Friluftsscenen!','<p>Du kender ham nok fra sangene “Millionær” og “Lidt i Fem” - søn af Tommy Seebach, kommer og spiller op for Vrøgums Friluftsscenen og alle er velkomne! Tag dine børn under armen og kom og giv en svingom, når Seebach skruer op for bassen eller en pardans med din partner, når han skruer helt ned for tempoet! Det bliver en festglad dag uanset og du kan medbringe alle dem du vil ha’ med!</p>','assets/img/vroegum-byfest_01.jpg','Start date','End date','Place',false,false,6,];
